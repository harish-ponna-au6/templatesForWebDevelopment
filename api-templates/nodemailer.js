// NPM packages
const nodemailer = require('nodemailer'); //for automatic mail sending

// Creating Transporting Service(here it is google)
...
transport.verify().then((res) => console.log(res));// verifying whether service connected or not 
